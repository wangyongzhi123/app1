        ...
        <div class="container mx-auto p-4">
            <form action="{{ Route('comments.feed') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="comment_url" name="comment_url" value="@if(!empty($commentUrl)){{$commentUrl}} @endif"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
                </div>
                    ...
                    @if(isset($feed) && !empty($feed))
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 mb-4">
                            ...
                            @if(!empty($feed['topicContent']['imageOriginals']))
                                ...
                                <img src="{{ $image }}" alt="Feed Image" class="mt-4" width="300px" style="float: left">
                                @endforeach
                            @endif
                            ...
                            <div class="container mx-auto p-4">
                                <div class="flex items-center mb-4">
                                    ...
                                    <img src="{{ $feed['user']['avatar'] }}" alt="{{ $feed['user']['userName'] }}" class="w-32 h-32 rounded-full">
                                    ...
                                    <div class="mt-4">
                                        @foreach($comment['replyList'] as $reply)
                                            <div class="bg-gray-100 rounded-lg p-4 mb-2">
                                                <p class="text-gray-800 font-bold">{{ $reply['fromUser']['userName'] }} <span class="text-gray-600">回复</span> {{ $reply['toUser']['userName'] }}</p>
